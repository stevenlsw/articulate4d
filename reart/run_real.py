...
from dataset.dataset_video import Sequence
...
def main(args):
    ...
    # TODO: remove hardcode intrinsic
    intrinsic_matrix = np.array(
        [[1373.8807373046875 / 7.5, 0 , 719.4837646484375 / 7.5],
        [0, 1373.8807373046875 / 7.5, 963.06695556640625 / 7.5],
        [0, 0, 1]])
    
    dataset = Sequence(data_root=args.seq_dir, id_list=args.id_list, intrinsic_matrix=intrinsic_matrix, 
                       num_points=args.num_points, cano_idx=args.cano_idx)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--seq_dir", default="../laptop2", type=str)
    parser.add_argument("--id_list", nargs="+", type=int, default=[0, 24, 34, 49, 65, 85], help="select frame indices")
